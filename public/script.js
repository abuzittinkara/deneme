...
function joinRoom(groupId, roomId, roomName) {
  ...
  currentRoom = roomId;
  console.log("Kanal seçildi =>", roomName);

  // Bu bar => solda 265px, sağda 200px => tam ortayı kaplayacak
  // => Horizontal bar yok => "Kanal Seçilmedi" => buraya
}
