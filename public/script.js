...
function initUIEvents() {
  ...
  toggleDMButton.addEventListener('click', () => {
    ...
    if (!isDMMode) {
      ...
      isDMMode = false;
      // *** EKSTRA: textMessages container stil özelliklerini yeniden uygula ***
      const textMessages = document.getElementById('textMessages');
      if (textMessages) {
          textMessages.style.whiteSpace = 'normal';
          textMessages.style.overflowWrap = 'break-word';
          textMessages.style.overflowX = 'hidden';
      }
