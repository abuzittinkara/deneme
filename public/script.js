...
/* ---------- Grup Oluştur / Gruba Katıl Modal ---------- */
...
// Tıklama dışına => context menu'yi kapat
...
socket.on('roomsList', (roomsArray) => {
  ...
  roomsArray.forEach(roomObj => {
    ...
    // YENİ: createWaveIcon() => önce tanımladık
