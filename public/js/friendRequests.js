export function initFriendRequests(socket) {
  ...
  // Eski dmChannelTitle event listener'larını kaldırıp,
  // onun bulunduğu container (selectedDMBar) üzerinde event delegation uyguluyoruz.
  ...
  // Eski event listener eklemeleri kaldırıldı.
  
  // Yardımcı: Varsayılan dmChannelTitle içeriğini döndüren fonksiyon.
  ...
  // Yeni: createUserItem fonksiyonu. (dmPanel için)
  ...
  // Yeni: renderFriendList fonksiyonu (dmPanel içerisindeki arkadaş listesini yeniden oluşturur)
