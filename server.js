...
io.on("connection", (socket) => {
  ...
  socket.on('joinGroup', async (groupId) => {
    ...
    // 1) Eğer farklı bir gruba geçiyorsak => 
    //    eski gruptaki kanaldan çık.
  ...
  // renameGroup & deleteGroup (opsiyonel, aynen tutuyoruz)
